...
// 重置密码
const resetPass = id => axios.post(`/api/user/reset/${id}`).then(res => res.data);

export { userLogin, userMe, userLogout, userList, userDel, userUpdate, userAdd, changePass, resetPass };
